...
module Com.Mysql.Cj.Mysqlx.Protobuf.Operator (Operator(..)) where
import Prelude ((+), (/))
...
data Operator = Operator{name :: !(P'.Utf8), param :: !(P'.Seq Com.Mysql.Cj.Mysqlx.Protobuf.Expr)}
