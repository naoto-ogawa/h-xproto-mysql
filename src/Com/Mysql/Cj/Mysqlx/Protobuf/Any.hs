...
import qualified Com.Mysql.Cj.Mysqlx.Protobuf.Array as Com.Mysql.Cj.Mysqlx.Protobuf (Array)
import qualified Com.Mysql.Cj.Mysqlx.Protobuf.Object as Com.Mysql.Cj.Mysqlx.Protobuf (Object)
...
data Any = Any{type' :: !(Com.Mysql.Cj.Mysqlx.Protobuf.Any.Type), scalar :: !(P'.Maybe Com.Mysql.Cj.Mysqlx.Protobuf.Scalar),
               obj :: !(P'.Maybe Com.Mysql.Cj.Mysqlx.Protobuf.Object), array :: !(P'.Maybe Com.Mysql.Cj.Mysqlx.Protobuf.Array)}
